...
const renderField = ({ label, placeholder,input, meta: { touched, error, warning, asyncValidating },
  input: { onChange, ...restInput, onBlur } }) => {
  ...
  return (
    <View >
      ...
      {touched && ((error && <Text style={{ color: 'red', marginLeft:30,marginTop:10 }}>{error}</Text>))}
    </View>);
};
